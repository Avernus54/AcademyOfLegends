...
public class Sounds {
	...
	public Sounds() {
		soundURL[0] = getClass().getResource("/sounds/redboyadventure.wav");
		...
		soundURL[5] = getClass().getResource("/sounds/hitmonster (1).wav");
		soundURL[6] = getClass().getResource("/sounds/BlueBoyAdventure.wav");
